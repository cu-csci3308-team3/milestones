...
insert into users_and_sessions(UserID, UserName, SessionID, UserStatus)
values
(1, 'UserOne', 'RAPXX', 'Creator'),
(2, 'UserTwo', 'RAPXX', 'User'),
(3, 'UserThree', 'RAPXX', 'User'),
(4, 'UserFour', 'ALTXX', 'Creator'),
(5, 'UserFive', 'ALTXX', 'User'),
(6, 'UserSix', 'ALTXX', 'User'),
(7, 'UserSeven', 'CNTRY', 'Creator'),
(8, 'UserEight', 'CNTRY', 'User'),
(9, 'UserNine', 'CNTRY', 'User');
